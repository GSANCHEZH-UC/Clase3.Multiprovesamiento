...
def main():
  ...
  ventas_by_category = analizar_categoria(df_completo, 'category', 'revenue')
  ventas_by_gender = analizar_categoria(df_completo, 'gender', 'revenue')
  ventas_by_city = analizar_categoria(df_completo, 'city', 'revenue')
  print("\nVentas por categoría:")
  print(ventas_by_category)
  print("\nVentas por género:")
  print(ventas_by_gender)
  print("\nVentas por ciudad:")
  print(ventas_by_city)
